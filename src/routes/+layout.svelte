<script>
  ...
  const title = "Svelte Cryptcurrency Icons"
...
<MetaTags
  ...
  openGraph={{
    type: 'website',
    url: 'https://svelte-cryptocurrency-iconss.vercel.app/',
    title: "Svelte Cryptcurrency Icons",
    description: "Svelte Cryptcurrency icon set for Svelte",
    images: [{ url: 'https://open-graph-vercel.vercel.app/api/svelte-cryptocurrency-icons', width: 1200, height: 630, alt: "Svelte Cryptcurrency Icons" }],
